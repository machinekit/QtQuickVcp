...
**
****************************************************************************/
#ifndef APPLICATION_STATUS_SUBSCRIBE_H
#define APPLICATION_STATUS_SUBSCRIBE_H
#include <QObject>
#include <QSet>
#include <QDebug>
#include <QTimer>
...
public:
    explicit StatusSubscribe(QObject *parent = nullptr);
    ~StatusSubscribe();
...
#endif // APPLICATION_STATUS_SUBSCRIBE_H
