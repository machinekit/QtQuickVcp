...
**
****************************************************************************/
#ifndef APPLICATION_LOG_SERVER_H
#define APPLICATION_LOG_SERVER_H
#include <QObject>
#include <QSet>
...
public:
    explicit LogServer(QObject *parent = nullptr);
    ~LogServer();
...
signals:
    ...
    void stateChanged(LogServer::State state);
...
#endif // APPLICATION_LOG_SERVER_H
