...
**
****************************************************************************/
#ifndef APPLICATION_ERROR_BASE_H
#define APPLICATION_ERROR_BASE_H
#include <QObject>
#include <QSet>
...
public slots:
    ...
    void setErrorUri(const QString &uri)
    {
...
signals:
    void errorUriChanged(const QString &uri);
...
#endif // APPLICATION_ERROR_BASE_H
