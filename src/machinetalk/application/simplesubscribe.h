...
**
****************************************************************************/
#ifndef APPLICATION_SIMPLE_SUBSCRIBE_H
#define APPLICATION_SIMPLE_SUBSCRIBE_H
#include <QObject>
#include <QSet>
...
signals:
    ...
    void stateChanged(SimpleSubscribe::State state);
...
#endif // APPLICATION_SIMPLE_SUBSCRIBE_H
