...
MACHINETALK_PATH = $$PWD/../../src/machinetalk/
INCLUDEPATH += $$MACHINETALK_PATH
HEADERS += $$MACHINETALK_PATH/machinetalkservice.h

SOURCES += $$MACHINETALK_PATH/machinetalkservice.cpp

SOURCES += \
    test_machinetalkservice.cpp \
    main.cpp
DEFINES += SRCDIR=\\\"$$PWD/\\\"
